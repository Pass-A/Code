...
public class MyInterface extends JFrame{
	...
	JButton sipButton,dipButton,searchButton,pauseButton,startButton,clearButton;
	JPanel panel;  
	...
	public MyInterface(){
		...
		pauseButton = new JButton("停止");
		pauseButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				allpackets.setFilter("a");				
			}
		});
		startButton = new JButton("继续");
